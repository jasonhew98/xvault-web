...
export default {
    ...
    async getTransactions() {
        return await xvaultService.get(`${paths.transaction}?sortBy=paymentMethod&sortOrder=1&pageSize=10&currentPage=1`, { authType: 'bearer' });
    },
    ...
    async deleteTransaction(transactionId) {
        return await xvaultService.delete(`${paths.transaction}/${transactionId}`, { authType: 'bearer' });
    }
};