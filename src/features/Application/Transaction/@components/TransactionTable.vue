  ...
  <div class="custom-table w-full overflow-x-auto rounded-xl">
    <div class="min-w-[1170px] bg-black-light p-4">
      <div class="grid grid-cols-12 px-5 py-4 lg:px-7.5 2xl:px-11">
        <div class="col-span-2" v-for="(header, index) in tableHeaders" :key="header.id" :index="index">
      ...
      <div v-if="hasRecords">
        <transaction-table-row v-for="(record, index) in records" :key="record.transactionId" :index="index"
          :record="record">
