<template>
    <tr>
        <td class="py-5 px-4">
            <p class="text-black dark:text-white">{{ mainCategory }}</p>
        </td>
        <td class="py-5 px-4">
            <p class="text-black dark:text-white">{{ subCategory }}</p>
        </td>
        <td class="py-5 px-4">
            <p class="text-black dark:text-white">{{ transactionDate }}</p>
        </td>
        <td class="py-5 px-4">
            <p class="text-black dark:text-white">{{ paymentMethod }}</p>
        </td>
        <td class="py-5 px-4">
            <p class="text-black dark:text-white">{{ paymentAmount }}</p>
        </td>
        <td class="py-5 px-4">
