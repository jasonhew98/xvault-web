<template>
    <header class="z-1 flex flex-none items-center bg-white shadow-sm dark:bg-gray-800">
        <div class="container mx-auto px-4 lg:px-8 xl:max-w-7xl">
            <div class="flex justify-between py-4">
            <div class="flex items-center">
                <a href="#" class="flex flex-row items-center justify-center logo-name gap-2">
                    <div class="w-10 h-10 icon icon-box-logo"></div>XVAULT
                </a>
            </div>
            ...
            <div class="flex items-center space-x-2 lg:space-x-5">
                ...
                <nav class="hidden items-center space-x-2 lg:flex">
                    <div class="nav-menu-item group" v-for="menuItem in menuItems" :key="menuItem.id">
                        <div class="nav-icon">
                ...
                <Menu as="div" class="relative inline-block">
                    ...
                    <MenuButton class="inline-flex items-center justify-center space-x-2 rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm font-semibold leading-5 text-gray-800 hover:border-gray-300 hover:text-gray-900 hover:shadow-sm focus:ring focus:ring-gray-300 focus:ring-opacity-25 active:border-gray-200 active:shadow-none dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:border-gray-600 dark:hover:text-gray-200 dark:focus:ring-gray-600 dark:focus:ring-opacity-40 dark:active:border-gray-700">
                        <span>John</span>
                        <svg
                ...
                <Transition
                    ...
                    <MenuItems class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-lg shadow-xl focus:outline-none dark:shadow-gray-900" >
                    <div class="divide-y divide-gray-100 rounded-lg bg-white ring-1 ring-black ring-opacity-5 dark:divide-gray-700 dark:bg-gray-800 dark:ring-gray-700" >
                        <div class="space-y-1 p-2.5">
                        <MenuItem v-slot="{ active }">
                            <a href="#" class="group flex items-center justify-between space-x-2 rounded-lg border border-transparent px-2.5 py-2 text-sm font-medium"
                            :class="{
                            ...
                            <div class="inline-flex rounded-full border border-blue-200 bg-blue-100 px-1.5 py-0.5 text-xs font-semibold leading-4 text-blue-700 dark:border-blue-700 dark:bg-blue-700 dark:text-blue-50">
                                2
                            </div>
                            </a>
                        </MenuItem>
                        <MenuItem v-slot="{ active }">
                            <a
                            href="#"
                            class="group flex items-center justify-between space-x-2 rounded-lg border border-transparent px-2.5 py-2 text-sm font-medium"
                            :class="{
                                'bg-blue-50 text-blue-800 dark:border-transparent dark:bg-gray-700/75 dark:text-white':
                                active,
                                'text-gray-700 hover:bg-blue-50 hover:text-blue-800 active:border-blue-100 dark:text-gray-200 dark:hover:bg-gray-700/75 dark:hover:text-white dark:active:border-gray-600':
            ...
            >
            <nav
                class="flex flex-col space-y-2 border-t py-4 dark:border-gray-700"
            >
                <a
                href="#"
                class="group flex items-center space-x-2 rounded-lg border border-blue-50 bg-blue-50 px-3 py-2 text-sm font-semibold text-blue-600 dark:border-transparent dark:bg-gray-700/75 dark:text-white"
                >
                <svg
                ...
                <a
                href="#"
                class="group flex items-center space-x-2 rounded-lg border border-transparent px-3 py-2 text-sm font-medium text-gray-800 hover:bg-blue-50 hover:text-blue-600 active:border-blue-100 dark:text-gray-200 dark:hover:bg-gray-700 dark:hover:text-white dark:active:border-gray-600"
                >
                <svg
...
.nav-menu-item {
    @apply flex items-center space-x-2 rounded-lg border border-transparent px-3 py-2 text-sm font-medium text-gray-800 hover:bg-blue-50 active:border-blue-100;
    @apply dark:text-gray-200 dark:hover:bg-gray-700 dark:hover:text-white dark:active:border-gray-600;
