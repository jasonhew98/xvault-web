                ...
                <div class="w-full py-17.5 md:max-w-[384px]">
                  ...
                  <form @submit.prevent="login">
                    <div class="flex flex-col gap-1 mb-4">
                      ...
                      <div class="relative flex items-center justify-center">
                        <input type="text" class="input__box"
                          ...
                          @click="v$.username.$reset()" v-model="username">
                      </div>
                    ...
                    <div class="flex flex-col gap-1 mb-4">
                      ...
                      <div class="relative flex items-center justify-center">
                        <input class="input__box" :type="revealPassword ? 'text' : 'password'"
                          :class="[v$.password.$error ? 'border-red-error' : 'border-gray-light']"
                          @click="v$.password.$reset()" v-model="password">
                        <span class="absolute right-4">
                          <i class="fas cursor-pointer" @click="toggleRevealPassword" :class="[
                  ...
                  <div
                    class="flex w-full py-2 items-center justify-center cursor-pointer gap-3.5 rounded-lg border border-gray-light bg-gray px-4 font-medium hover:bg-opacity-70">
                    <span>
...
.input__box {
  @apply w-full rounded-lg border bg-transparent py-2 px-3 outline-none hover:border-green focus-visible:shadow-none text-white transition-all ease-in-out duration-300;
}
</style>