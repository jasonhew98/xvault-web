                            ...
                            <div class="w-full px-4 sm:px-12.5 flex items-center justify-center xl:w-1/2 py-6">
                                <div class="w-full py-17.5 md:max-w-[384px]">
                                    ...
                                    <form @submit.prevent="login">
                                        ...
                                        <div class="mb-5 mt-6">
                                            <button
                                                class="w-full py-2 cursor-pointer rounded-lg border border-green bg-green px-4 font-medium text-black transition hover:bg-green-dark">
                                                <i class="fa fa-spinner fa-spin"
                                                    :class="{ 'hidden': !isLoginLoading }"></i>
                                    ...
                                    <div class="mt-6 text-center">
                                        <p class="font-medium"> Don’t have any account?
                                            <a href="/register" class="text-green hover:text-green-dark">
                                                Sign up
                                            </a>
                                        </p>
                                    </div>
                                    ...
                                    <span class="mt-15 inline-block">
                                        <svg width="350" height="350" viewBox="0 0 350 350" fill="none"
                                            ...
                                            <path
                                                ...
                                                fill="#CCCCCC" />
                                            <path d="M204.934 209.464H102.469V210.423H204.934V209.464Z"
                                                fill="#CCCCCC" />
                                            <path
                                                ...
                                                class="fill-green" />
                                            <path d="M204.934 241.797H102.469V242.757H204.934V241.797Z"
                                                fill="#CCCCCC" />
                                            <path
