<template>
    <div class="landing-container h-full">
        <div class="main main-landing flex flex-col">
            <XWebNav :options="actionConfigurations" :sideOptions="sideActionConfigurations"></XWebNav>
            <main class="flex-1">
                <div class="h-full mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10 flex flex-col justify-center">
                    <div class="">
                        <div class="flex flex-wrap items-stretch">
                            <div class="w-full px-4 sm:px-12.5 flex items-center justify-center xl:w-1/2 py-6">
                                <div class="w-full py-17.5 md:max-w-[384px]">
                                    ...
                                    <div class="flex w-full py-2 items-center justify-center cursor-pointer gap-3.5 rounded-lg border border-gray-light px-4 font-medium hover:bg-opacity-70">
                                        <span>
                                    ...
                                    <div class="mt-6 text-center">
                                        <p class="font-medium"> Already have an account?
                                            <a href="/login"
                                                class="text-green hover:text-green-dark">
                                                Log In
                                            </a>
                                        </p>
                                    </div>
                                ...
                                <div class="py-17.5 text-center w-full max-w-[350px]">
                                    ...
                                    <span class="mt-15 inline-block">
                                        <svg width="350" height="350" viewBox="0 0 350 350" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <path d="M170.862 133.966C177.192 133.966 182.325 128.838 182.325 122.512C182.325 116.186 177.192 111.057 170.862 111.057C164.531 111.057 159.398 116.186 159.398 122.512C159.398 128.838 164.531 133.966 170.862 133.966Z" class="fill-green"/>
                                            ...
                                            <path d="M105.705 203.477C107.492 203.477 108.941 202.029 108.941 200.243C108.941 198.457 107.492 197.01 105.705 197.01C103.918 197.01 102.469 198.457 102.469 200.243C102.469 202.029 103.918 203.477 105.705 203.477Z" class="fill-green"/>
                                            <path d="M204.934 241.797H102.469V242.757H204.934V241.797Z" fill="#CCCCCC"/>
                                            <path d="M105.705 235.811C107.492 235.811 108.941 234.363 108.941 232.577C108.941 230.791 107.492 229.344 105.705 229.344C103.918 229.344 102.469 230.791 102.469 232.577C102.469 234.363 103.918 235.811 105.705 235.811Z" class="fill-green"/>
                                            <path d="M203.062 278.617H170.68C170.121 278.617 169.584 278.394 169.189 277.999C168.793 277.604 168.571 277.068 168.57 276.509V265.168C168.571 264.609 168.793 264.073 169.189 263.678C169.584 263.283 170.121 263.06 170.68 263.06H203.062C203.621 263.06 204.158 263.283 204.553 263.678C204.949 264.073 205.171 264.609 205.172 265.168V276.509C205.171 277.068 204.949 277.604 204.553 277.999C204.158 278.394 203.621 278.617 203.062 278.617Z" class="fill-green"/>
                                            <path d="M116.263 203.477C118.05 203.477 119.499 202.029 119.499 200.243C119.499 198.457 118.05 197.01 116.263 197.01C114.476 197.01 113.027 198.457 113.027 200.243C113.027 202.029 114.476 203.477 116.263 203.477Z" class="fill-green"/>
                                            <path d="M126.818 203.477C128.605 203.477 130.054 202.029 130.054 200.243C130.054 198.457 128.605 197.01 126.818 197.01C125.031 197.01 123.582 198.457 123.582 200.243C123.582 202.029 125.031 203.477 126.818 203.477Z" class="fill-green"/>
                                            <path d="M116.263 235.811C118.05 235.811 119.499 234.363 119.499 232.577C119.499 230.791 118.05 229.344 116.263 229.344C114.476 229.344 113.027 230.791 113.027 232.577C113.027 234.363 114.476 235.811 116.263 235.811Z" class="fill-green"/>
                                            <path d="M126.818 235.811C128.605 235.811 130.054 234.363 130.054 232.577C130.054 230.791 128.605 229.344 126.818 229.344C125.031 229.344 123.582 230.791 123.582 232.577C123.582 234.363 125.031 235.811 126.818 235.811Z" class="fill-green"/>
                                            ...
                                            <path d="M316.556 202.365C321.672 204.17 322.573 223.716 322.573 223.716C316.554 220.409 309.332 225.821 309.332 225.821C309.332 225.821 307.827 220.709 306.022 214.094C305.477 212.233 305.412 210.265 305.832 208.372C306.253 206.479 307.147 204.724 308.429 203.269C308.429 203.269 311.44 200.56 316.556 202.365Z" class="fill-green-dark"/>
            ...
            <XWebFooter type="minimalist"></XWebFooter>
        </div>
    </div>
</template>
...
const v$ = useVuelidate(rules, { username, password }).value;
...
const login = async () => {
    ...
    try {
        ...
        const [error, result] = await authRepository.value.signup(record);
        if (error) {
