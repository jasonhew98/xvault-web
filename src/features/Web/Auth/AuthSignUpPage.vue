            ...
            <div class="flex flex-wrap items-stretch">
              <div class="w-full px-4 sm:px-12.5 flex items-center justify-center xl:w-1/2 py-6">
                <div class="w-full py-17.5 md:max-w-[384px]">
                  ...
                  <div
                    class="flex w-full py-2 items-center justify-center cursor-pointer gap-3.5 rounded-lg border border-gray-light px-4 font-medium hover:bg-opacity-70">
                    <span>
                  ...
                  <div class="mt-6 text-center">
                    <p class="font-medium"> Already have an account?
                      <a href="/login" class="text-green hover:text-green-dark">
                        Log In
                      </a>
                    </p>
                  </div>
