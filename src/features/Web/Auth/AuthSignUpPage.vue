                                ...
                                <div class="w-full py-17.5 md:max-w-[384px]">
                                    ...
                                    <form @submit.prevent="login">
                                        <div class="flex flex-col gap-1 mb-4">
                                            ...
                                            <div class="relative flex items-center justify-center border border-stroke rounded-lg hover:border-green
                                        ...
                                        <div class="mb-5 mt-6">
                                            <button class="w-full h-12 cursor-pointer rounded-lg border border-green bg-green px-4 font-medium text-black transition hover:bg-opacity-90">
